...
/**
 * MissionCard component for displaying a summary of a mission on mobile devices.
 * @param {object} props - The component props.
 * @param {object} props.mission - The mission object to display.
 ...
 */
export default function MissionCard({ mission, onEdit, onDelete }) {
  ...
  return (
    <li className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
      {/* Top Section: Title, Description, and Type */}
