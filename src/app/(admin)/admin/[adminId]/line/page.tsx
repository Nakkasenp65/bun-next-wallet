...
const Toolbar = ({ filters, onFilterChange, filterOptions }: ToolbarProps) => {
  const brandOptions = [
...
const ProductFormModal = ({ open, initial, onClose, onSubmit, isProcessing }: ProductFormModalProps) => {
...
export default function AdminProductsPage() {
  ...
  const { mutate: createProduct, isPending: isCreating } = useAdminCreateProduct();
  const { mutate: editProduct, isPending: isEditing } = useAdminEditProduct();
