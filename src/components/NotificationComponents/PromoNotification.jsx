...
export default function PromoNotification({ promo, displayIcon: IconComponent, onClick }) {
  ...
  return (
    ...
    >
      {/* Icon */}
      <div className="mt-1 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-vibrant-purple/20 text-xl text-vibrant-purple">
      ...
      {/* Unread Indicator */}
      {!promo.isRead && (
        <div className="absolute top-3 right-3 h-2.5 w-2.5 rounded-full bg-primary-pink shadow-md"></div>
      )}
    </li>
  );
}
